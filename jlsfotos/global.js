...
//2nd is a JSON object with the data to be sent. 1st 'name' refers to the variable declared on line 2, the second refers to value.  
//3rd arg is an anon function that returns the data given from the name.php file.